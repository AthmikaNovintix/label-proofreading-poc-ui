...
const DraggableBoxOverlay = ({
  ...
  const handleDelete = (idx: number) => {
    const newBoxes = initialBoxes.filter((_, i) => i !== idx);
    setStates(newBoxes.map(b => ({ x: b.x, y: b.y, w: b.width, h: b.height })));
    setSelectedIdx(null);
  ...
  return (
    <div className="border border-border bg-white">
      ...
      <div className={`grid ${singlePanel ? "grid-cols-1" : "grid-cols-2"}`}>
        ...
        {/* Child panel — PlacementOverlay is a SIBLING of TransformWrapper */}
